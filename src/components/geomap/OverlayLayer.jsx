...
const CANAL_STYLE_COLORS = {
  ...
  "luminous":  { fill: "#29b6f6", stroke: "#0d47a1" },
  "dotted":    { fill: "#29b6f6", stroke: "#0d47a1" },
  "natural":   { fill: "#4fc3f7", stroke: "#2e7d32" },
  "dualTone":  { fill: "#29b6f6", stroke: "#0d47a1" },
  "hatched":   { fill: "#4fc3f7", stroke: "#0d47a1" },
