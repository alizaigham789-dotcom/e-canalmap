...
export default function Form4_Naqshbandi57() {
  const [f, setF] = useState({
    number: "", date: "", mukhatabSection: "",
    moqaIrvi: "", rajbah: "", babatDarkhwast: "",
    naamNaqshi: "", morzah: "",
  ...
  return (
    ...
    >
      ...
      <FormSection className="mb-5 space-y-3">
        ...
        <div className="text-sm text-slate-600 pt-1 font-medium" style={{ direction: "rtl", fontFamily: "serif" }}>
      ...
      <div className="bg-purple-50 border border-purple-100 rounded-xl p-4 mb-5 text-sm leading-7 text-slate-700" style={{ direction: "rtl", fontFamily: "serif" }}>
        <p>تلمی ہے کہ سائل اسائلان نے درخواست گزاری ہے کہ زیر دفعہ 57 کینال کے تحت ان کی دارہ بندی میں ترمیم کی جائے۔ آپ کو اس ضمن میں پابندگیا جاتا ہے کہ رتنزرزگرہ و جملہ حصہ داران موقع کو اطلاعیابی کروائیں کہ وہ موقع موژرہ</p>
